...
public class AdicionarClienteUseCase
{
    ...
    public AdicionarClienteUseCase(IGeoLocalizacaoService geolocalizacaoService, ITokenService tokenService, IClienteRepository repo, IUsuarioRepository usuarioRepository, ClienteEntity input)
    {
    ...
    public ClienteEntity Execute()
    {
        ...
        {
            throw new Exception($"Usuário \"{usuarioEntity.Login}\" é do tipo \"Colaborador\".");
        }
