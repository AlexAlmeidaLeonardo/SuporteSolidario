...
public class ClienteController : BaseController
{
    ...
    [HttpGet]
    public ActionResult MensagemCliente(long idAtendimento)
    {
        MensagemClienteViewModel mensagemCliente = new MensagemClienteViewModel();
        mensagemCliente.TITULO_PAGINA = "Conversa com o colaborador";
        mensagemCliente.IdAtendimento = idAtendimento;

        BuscarMensagensUseCase buscarMensagens = new BuscarMensagensUseCase(_atendimentoMensagemRepository, idAtendimento);
        mensagemCliente.ListaMensagens = buscarMensagens.Execute();

        BuscarColaboradorPorAtendimentoUseCase buscarColaboradorAtendimento = new BuscarColaboradorPorAtendimentoUseCase(_colaboradorRepository, idAtendimento);
        ColaboradorDTO colaborador = buscarColaboradorAtendimento.Execute();
        mensagemCliente.NomeColaborador = colaborador.Nome + " " + colaborador.Sobrenome;

        return View(mensagemCliente);
    }

    [HttpPost]
    public ActionResult MensagemCliente(MensagemColaboradorViewModel mensagemColaborador)
    {
        if (string.IsNullOrEmpty(mensagemColaborador.Mensagem))
        {
            mensagemColaborador.TITULO_PAGINA = "Conversa com o colaborador";
            ...
            BuscarColaboradorPorAtendimentoUseCase buscarColaboradorAtendimento = new BuscarColaboradorPorAtendimentoUseCase(_colaboradorRepository, mensagemColaborador.IdAtendimento);
            ColaboradorDTO colaborador = buscarColaboradorAtendimento.Execute();
            mensagemColaborador.NomeCliente = colaborador.Nome + " " + colaborador.Sobrenome;
        ...
        AdicionarMensagemClienteUseCase adicionarMensagemCliente = new AdicionarMensagemClienteUseCase(_atendimentoMensagemRepository, mensagem);
        mensagem = adicionarMensagemCliente.Execute();
